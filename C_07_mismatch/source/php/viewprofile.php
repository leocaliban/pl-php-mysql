...
<body>
  ...
  if (mysqli_num_rows($data) == 1) {
    ...
    if (!empty($row['imagem'])) {
      echo '<tr><td class="label">Foto de perfil:</td><td><img src="' . MM_UPLOADPATH . $row['imagem'] .
        '" alt="Foto de perfil" /></td></tr>';
    }
    echo '</table>';
    if (!isset($_GET['id']) || ($id == $_GET['id'])) {
      echo '<p>Você gostaria de <a href="editprofile.php">atualizar seu perfil</a>?</p>';
    }
  } else {
